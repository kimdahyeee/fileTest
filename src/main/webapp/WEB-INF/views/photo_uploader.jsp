...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(<c:url value='/resources/photo_uploader/img/bg_drag_image.png'/>) 0 0 no-repeat}
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="<c:url value='/fileUpload'/>" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
    ...
    <div id="pop_container" class="pop_container" style="display:none;">    	<!-- content -->
        <div id="pop_content">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="<c:url value='/resources/photo_uploader/img/btn_confirm.png'/>" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="<c:url value='/resources/photo_uploader/img/btn_cancel.png'/>" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type="text/javascript" src="<c:url value='/resources/photo_uploader/jindo.min.js'/>" charset="utf-8"></script>
<script type="text/javascript" src="<c:url value='/resources/photo_uploader/jindo.fileuploader.js'/>" charset="utf-8"></script>
<script type="text/javascript" src="<c:url value='/resources/photo_uploader/attach_photo.js'/>" charset="utf-8"></script>
