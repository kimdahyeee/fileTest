	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/daou/resources/photo_uploader/img/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","/daou/resources/photo_uploader/img/btn_confirm.png");
    	 }
     }   
    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/daou/file_uploader_html5'; 	//upload URL
